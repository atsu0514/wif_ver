...
MODELS_DIR = os.path.join(BASE_DIR, "GRU")
...
MODEL_PATH = os.path.join(ARTIFACT_DIR, "gru_model.pth")
...
class RealtimeLikeOfflineEvaluator:
    ...
    def __init__(self):
        ...
        self.model = GRUModel(input_size=3, hidden_size=HIDDEN_SIZE, num_layers=NUM_LAYERS, output_size=2)

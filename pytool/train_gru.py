...
TEST_CSV = "cleaned_sensor_data_20251211_143553.csv"

BASE_DIR = Path(__file__).resolve().parents[1]  # プロジェクトルート
MODELS_DIR = BASE_DIR / "GRU"
...
MODEL_PATH = ARTIFACT_DIR / "gru_model.pth"
...
def main():
    ...
    model = GRUModel(input_size=3, hidden_size=HIDDEN_SIZE, num_layers=NUM_LAYERS, output_size=2)
